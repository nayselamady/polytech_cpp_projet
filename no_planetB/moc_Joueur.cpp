...
QT_MOC_LITERAL(1, 7, 3), // "win"
QT_MOC_LITERAL(2, 11, 0), // ""
QT_MOC_LITERAL(3, 12, 6) // "winner"

    },
    "Joueur\0win\0\0winner"
};
...
void Joueur::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Joueur::win)) {
                *result = 0;
                return;
            }
        }
...
void *Joueur::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Personnage"))
        return static_cast< Personnage*>(this);
